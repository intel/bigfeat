-- Get a map of the 10 most recent item_sk every customer interacted with
...
-- Get a map of the 10 recent item_sk every customer purchased (action = 5)
...
-- Get a map of the 10 recent item categories every customer purchased (action = 5)
...
-- Get a map of the 10 most expensive item categories every customer purchased (action = 5)
